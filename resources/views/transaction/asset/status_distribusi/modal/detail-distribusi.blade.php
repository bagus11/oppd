                        ...
                        <div class="container mt-2">
                            ...
                            <fieldset class="mt-4 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label id="edit_label_kondisi"></label>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <form class="form" id="form_serialize" enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <select name="update_select_kondisi" id="update_select_kondisi" class="select2">
                                                ...
                                                <span class="message_error update_kondisi_error text-danger d-block"></span>
                                            </div>
                                        </div>
